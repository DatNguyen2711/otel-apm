...
1. Trong trường hợp chạy trên k8s cần sửa lại domain của API, path **fe/index.html**

Domain khi chạy trên k8s nằm trong các file **fe-ingress.yaml apigw-ingress.yaml noti-ingress.yaml**

2. Khi chạy trên docker hay k8s thì khi dựng xong mysql phải exec vào mysql rồi chạy file sql trong  **sql/url_access.sql**